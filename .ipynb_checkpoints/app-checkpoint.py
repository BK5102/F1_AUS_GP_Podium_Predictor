...
# Post-race results
st.subheader("Post-Race Results")

results = pd.DataFrame({
    'Driver': ['RUS', 'ANT', 'LEC', 'HAM', 'NOR'],
    'Finish': ['P1', 'P2', 'P3', 'P4', 'P5'],
    'Predicted Probability': ['11.4%', '0.0%', '80.4%', '93.3%', '69.6%'],
    'Predicted vs Actual': ['Surprise', 'Surprise', 'Correct', 'Near Miss', 'Near Miss']
})

st.dataframe(results, use_container_width=True)

st.markdown("""
**Takeaway:** The model correctly identified LEC as a podium contender, but missed the other two contenders. Russell winning from P5 and Antonelli finishing P2 on his F1 debut. The model's core limitation was exposed here. It had no way to capture 
